...
- **```/subscribers```** : This is the first endpoint. After making this call the server responds with an array of objects of subscribers with all their details.
...
2. Link for local cloning: https://github.com/shaswattejankar/youtubesubscribers.git
